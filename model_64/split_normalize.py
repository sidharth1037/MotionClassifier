...
# ========== CONFIG ==========
DATA_FILE = "motion_windows_v6_64.npz"
OUT_FILE = "motion_dataset_loso_v6_64.npz"
NUM_CLASSES = 4
MIN_TEST_SAMPLES = 50
...
AUGMENT_TIME_SHIFT_MAX = 6    # Max samples to shift (reduced proportionally for 64-sample window)
AUGMENT_COPIES = 3            # 3 copies: compensate for harder task with less temporal context
# ============================

print("=" * 70)
print("DATASET SPLITTING, AUGMENTATION & NORMALIZATION - LOSO Validation (V6_64)")
print("=" * 70)
