...
# ========== CONFIG ==========
DATA_FILE = "motion_windows_v5.npz"
OUT_FILE = "motion_dataset_loso_v5.npz"
NUM_CLASSES = 4
MIN_TEST_SAMPLES = 50
...
print("=" * 70)
print("DATASET SPLITTING & NORMALIZATION - LOSO Validation")
print("=" * 70)
...
# 4) Normalization (Train set statistics only)
print("\n5. NORMALIZATION")
...
print("\n" + "=" * 70)
print("NEXT STEP: Run 'python model_v5.py' to train the model")
print("=" * 70)